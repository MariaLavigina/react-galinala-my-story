...
// ⭐ Preload Chapter 2 hero image for current screen size
useEffect(() => {
  ...
  if (width >= 1024) {
    // Desktop
    heroImg = "/images/desktop-images/chapter-02-desktop.webp";
  } else {
    // Mobile & iPad
    heroImg = "/images/mobile-images/chapter-02-mobile.webp";
  }
