...
// ⭐ Preload Chapter 1 hero image for current screen size
useEffect(() => {
  ...
  if (width >= 1024) {
    // Desktop
    heroImg = "/images/desktop-images/chapter-01-desktop.webp";
  } else {
    // Mobile & iPad
    heroImg = "/images/mobile-images/chapter-01-mobile.webp";
  }
