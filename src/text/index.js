...
const texts = {
  ru: {
    ...
    threeWomen: `Три женщины, три поколения: моя дочка Маша, я и моя мама`
  },
    ...
    paragraphs2: [
      ...
      `Для ее семьи. Они - британцы, не имеющие представления ни о Советском Союзе, ни об Израиле, ни о том, что значит быть “олим ходашим ми Русия”.
       Насколько Европа и мы имеем разную историю одних и тех же событий мне пришло в голову, когда я как-то сказала новым своим родственникам: мое свидетельство о рождении выдано в первый день Второй Мировой войны и меня спросили: сентябрь 1939-ого? Вот так, для нас это июнь 1941-ого, а их уже 2 года бомбят. И - немного для тех, кто в России...`,
      `Маша давно и упорно просила: "Пиши, как всё это было". Даже тетрадку для этого купила - очень красивую. Я начала писать и время от времени читала Маше. И однажды она сказала: "Я хочу сделать из этого фильм." Мы начали снимать, но, увы, вскоре пришли к выводу: Маша - не Стивен Спилберг, а я - не Морган Фриман. Так родился этот сайт «Каждый выбирает для себя». Я ходила и бормотала эти строки Юрия Левитанского - то так, то сяк. И вдруг поймала себя на мысли: ну так я последние тридцать лет и живу в стране, где у человека и в самом деле есть выбор. Он - и только он - решает: "Дьяволу служить или пророку..." `,
      `Я не хочу сказать, что в Израиле нет жуликов, ловкачей и прочих. Но здесь есть возможность жить без всего этого, и при этом не нужно быть ни героем, ни борцом, а просто - в лучшем смысле этого слова - обывателем.`,
    ...
    paragraphs3: [
      ...
      `Третья глава - это сборник маленьких историй, рассказанных моей дочерью Машей, - порой забавных, порой трогательных. Но сквозь них проступает драма ребёнка, внезапно оказавшегося в мире изобилия - того, что раньше “только в кино видела”, и полного безденежья.`,
 ...
 alt: {
  ...
  paragraphsBeforeH3: [
    ...
    paragraphs3: [
      ...
      `The third chapter is a collection of small stories told by my daughter Masha - sometimes funny, sometimes touching. Through them emerges the drama of a child who suddenly finds herself in a new place where abundance - things she had previously “only seen in movies”- exists alongside complete lack of money.`,
  ...
  alt: {
    ...
    h1: `יש לנו אפשרות - אפשרות אמיתית - ומה שנעשה איתה תלוי רק בנו.`,
    pBetween: [
  `כותרת סיפורי, "כל אחד בוחר את דרכו", בהשראת השיר "Каждый выбирает для себя" ("כל אחד בוחר עבור עצמו...") מאת המשורר הסובייטי והרוסי הנודע יורי לוויטנסקי.
...
שלוש נשים - אמא שלי, מאשה ואני - נכתוב על אותה תקופה.  

אבל מה עם אמא שלי? הרי הסיפור הוא גם שלה…  
נכתוב בשמה, דרך המכתבים שלה.  

יש לי את המכתבים שכתבה לֶטוֹמוֹצ'קָה ולֶאֶרִיק (הם שלחו לי אותם לפי בקשתי), וגם את המכתבים ששלחה לאִיגוֹר.  
...
`,
           `כך נולד האתר הזה: "כל אחד בוחר את דרכו".  `,
            `
הלכתי ומללתי לעצמי את השיר של יוּרִי לַבֶּטַנְסְקִי – "כָּל אֶחָד בּוֹחֵר עֲבוּר עַצְמוֹ". 
פעם כך, ופעם אחרת.  
ופתאום הבנתי:  
...
paragraphs3: [
  ...
  `הפרק השלישי הוא אוסף של סיפורים קצרים שסופרו על־ידי בתי מאשה - לעיתים מצחיקים, לעיתים נוגעים ללב. דרכם מתגלה הדרמה של ילדה שמוצאת את עצמה לפתע במקום חדש, שבו שפע - דברים שראתה בעבר “רק בסרטים” - מתקיים לצד מחסור מוחלט בכסף.`,
