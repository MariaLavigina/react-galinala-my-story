  ...
  `Профком и деятель были последняя и единственная возможность свозить ребёнка к морю в более сносных условиях. И я промолчала...`
    ...
    imageTextSections: [
      ...
      },
      {
        ...
        he:  `אוניברסיטת מוסקבה, או בשמה הרשמי "אוניברסיטת מוסקבה הממלכתית על שם מיכאיל לומונוסוב -  היא האוניברסיטה הגדולה והעתיקה ביותר ברוסיה. `,
        en: `Moscow University, or by its official name "Lomonosov Moscow State University," is the largest and oldest university in Russia.`,
        text: `Вот это я посередине - спускаюсь по ступеням Московского университета — во время одной из наших поездок в Москву, в Москве 2000-х. …и мои университетские "ордена" МГУ.`
      },
      {
        desktopSrc: null,
...
כשאני מספרת את זה, אני חושבת שהקורא המודרני יגיד: ‘נו ומה? קנית מה שרצית – מה הבעיה?’
 ...
 היא אמרה שאם לא תעקוף הוראות, אי אפשר היה לספק את הציוד הנדרש.`,
    ...
    ` “ומה גָּלִינָה יכולה לגנוב? אינטגרל – וגם אותו לא ממש שלה!”`
  ]
      }
    },
 ...
 ואז, בגאווה צורמת, היא מוסיפה:`,
  ...
  paragraphs: [
    `זה קרה בסוף שנות השבעים. לאוֹלֶג, הבן שלי, גנבו את האופניים: הוא שיחק בחצר בית הספר, התרחק לרגע - והאופניים נעלמו.`,
