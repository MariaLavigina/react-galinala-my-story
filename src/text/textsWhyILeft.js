...
כשאני מספרת את זה, אני חושבת שהקורא המודרני יגיד: ‘נו ומה? קנית מה שרצית – מה הבעיה?’
 ...
 ואז, בגאווה צורמת, היא מוסיפה:`,
  ...
  paragraphs: [
    `חברתי מהתיכון, טִימָה (כינוי מהבית ספר, וכך תמיד קראנו לה גם אני ובני משפחתי), עבדה תקופה כרופאה נוירולוגית ב-“המחלקה הרביעית” במשרד הבריאות של ברית המועצות, זו ששירתה את בכירי הפקידים המפלגתיים הסובייטיים.`,
    `היא סיפרה לי על מקרה שבו קראה לה ההנהלה ושאלה למה היא הפנתה חולה מסוימת לטיפול במקום מסוים. `,
     `טִימָה השיבה שהחולה באמת זקוקה לטיפול דווקא במקום הזה, בהתאם לאבחנה.`,
      ` אך הבוס התמרמר:`,
    ...
    `כך היה ברור שצריך להפנות אנשים לא לפי מצבם הרפואי, אלא לפי המשרה או דרגה שהם או בני משפחתם מחזיקים.`,
     ` טִימָה עזבה את המקום זמן קצר לאחר מכן.`
