...
const textsWeArrived = {
  ...
  text: [
        ...
        `Я до сих пор не могу к этому привыкнуть и мне доставляет особенное удовольствие  слегка  прогуляться  одной ночью. Мне как то в голову недавно пришло, что я забыла бояться входить в свой подъезд в позднее время и не оглядываться на шаги у меня за спиной. В Москве после 10 вечера меня всегда кто-нибудь встречал у остановки автобуса.`
      ]
    },
    {
      h4: "Вот она - та самая страна, что непостижимым образом приходила ко мне во сне.",
 text: [
        ...
        `Вот и разгадка моих снов!  Так это же эта страна, таким образом стучалась ко мне и настойчиво звала к себе.`
...

{
  ...
  },
  {
    ...
    {
      h1: "“Тагиди бевакаша эйфо купат холим”",
      text: [
        `На следующий день пришла Наташа Магазанник, рассказала, что надо нам сделать в первую очередь. Почти везде она меня сопровождала и казалось мне, что она уже давно в стране и все ей тут понятно и все она тут знает.  А приехала она всего за три месяца до меня, знала на иврите, по-моему, лишь одно слово “беседер”. Но знала его твёрдо и этим одним словом открывала все двери. Н.А. Магазанник сводил меня в банк, помог открыть счёт.  `,
         ` А в купат холим я пошла сама. Русскоязычные соседи объяснили мне дорогу. Я всю дорогу повторяла фразу, которой они меня научили, если придётся спросить дорогу: “Тагиди бевакаша эйфо купат холим”. В купат холим сразу поняли, что я ола хадаша и сделали все, что нужно. `,
          `В этих первых шагах в Израиле я удивлялась, как много совсем незнакомых, разных людей были готовы прийти на помощь. Было даже модно иметь опекаемую семью олим. Я как то спросила, чем я могу отплатить за помощь. И мне ответили: “Ты поможешь следующим олим хадашим”. Помню и стараюсь, по мере сил.  `,
    ...
    image: [
  {
    ...
    alt: "Наши первые фото в нашем первом городе. Реховот 1991 год",
...
скамеечку. Маша вежливо уступала им место, сдвигалась, пока в
 ...
 אני ואמא התקשרנו לאִיגוֹר.`,
    ...
    {
      text: [
  `הנהג, כפי שאני מבינה היום, לא הכיר את העיר ולא היה כנראה יכול לזכור את הכתובת. הוא עצר ליד כל עמוד תאורה (כבר היה חשוך),  הושיט את הפתק עם הכתובת אל האור, בדק אותו מול מספר הבית הקרוב ושם הרחוב, ואז נסע לעמוד התאורה הבא...`,
 ...
 לא מזמן עבר לי בראש - שכחתי בכלל לפחד להיכנס לבניין שלי בשעות מאוחרות, מבלי להסתובב ולהקשיב אם מישהו צועד מאחורי.`,
    ...
    },
    {
      ...
      text: [
       ...
       `אמי ומַאַשָׁה הלכו לישון, ואני, לפני שהלכתי גם, החלטתי לעשות סיבוב בבית ולבדוק שהכל בסדר. ואז קרה משהו שאני פשוט חייבת לספר עליו.`,
         ...
         `התחלתי אפילו לשאול אנשים שאני מכירה - יש בכלל תיקונים שעפים? אף אחד לא ידע, רק צחקו.`,
          `ועכשיו, בישראל, כבר בלילה הראשון פה, אני רואה ג'וק על הארון העליון במטבח.`,
           `אני מטפסת על שרפרף, מתכוונת לתפוס אותו בזהירות עם מפית - ואז, בדיוק כמו בחלומות שלי, נשמע קליק; הכנפיים נפתחות, והג'וק עף.`,
            `כמעט נפלתי מהשרפרף...`,
              `אז זו ההסבר לחלומותיי! זו הייתה דווקא המדינה הזו, שבאופן מיסטי דפקה עלי בשנתִי וקראה לי בעקשנות לבוא אליה.`
      ]
    },
    {
      image: [
    ...
    },
    {
      ...
      text: [
        `על המפה אני מחפשת את הבניין של משרד הפנים. אני אוהבת לנסות למצוא את המקום בעצמי ולא להסתמך על מישהו שילווה אותי. אבל ברגע שאני פותחת את המפה, מיד מישהו מופיע לידי ושואל: “אפשר לעזור?”`,
 ...
 ואז נזכרתי - היום יום שישי! אז כנראה אשאר פה גם היום וגם מחר.`,
      ...
      image: [
        {
          desktopSrc: "/images/desktop-images/first-days-in-israel.webp",
          mobileSrc: "/images/mobile-images/first-days-in-isreal-01.webp",
          alt: "Our first photos in our first city. Rehovot 1991",
